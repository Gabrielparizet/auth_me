...
config :auth_me, AuthMeWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: AuthMeWeb.ErrorHTML, json: AuthMeWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: AuthMe.PubSub,
  live_view: [signing_salt: "G+xCOTme"]
...
config :auth_me, AuthMe.UserManager.Guardian,
  issuer: "auth_me",
  secret_key: "ewIYbDN3Th8jIM/grFabAqUxlgpyBzGgJCPQ3SEsgavICJU6F599/xxAGChe1ogx"
